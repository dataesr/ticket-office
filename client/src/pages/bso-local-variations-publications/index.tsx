...
function BsoLocalVariationsPublicationsPage() {
...
export default function BsoLocalVariationsPublications() {
  return (
    <VariationsContext>
      <Container className="fr-my-5w">
        <Title>Demandes de déclinaisons locales - Publications</Title>
        <FiltersBar />
        <BsoLocalVariationsPublicationsPage />
      </Container>
    </VariationsContext>
  );
}
