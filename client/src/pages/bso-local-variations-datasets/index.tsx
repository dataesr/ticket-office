...
function BsoLocalVariationsDatasetsPage() {
...
export default function BsoLocalVariationsDatasets() {
  return (
    <VariationsContext>
      <Container className="fr-my-5w">
        <Title>Demandes de déclinaisons locales - Jeux de données</Title>
        <FiltersBar />
        <BsoLocalVariationsDatasetsPage />
      </Container>
    </VariationsContext>
  );
}
