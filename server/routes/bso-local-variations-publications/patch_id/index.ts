...
const patchBsoLocalVariationsPublicationsByIdRoute = new Elysia()

patchBsoLocalVariationsPublicationsByIdRoute.patch(
...
export default patchBsoLocalVariationsPublicationsByIdRoute
