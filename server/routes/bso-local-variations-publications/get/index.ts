...
const getBsoLocalVariationsPublicationsRoute = new Elysia()

getBsoLocalVariationsPublicationsRoute.get(
...
export default getBsoLocalVariationsPublicationsRoute
