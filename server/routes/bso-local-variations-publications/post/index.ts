...
const postBsoLocalVariationsPublicationsRoute = new Elysia();

postBsoLocalVariationsPublicationsRoute.post(
...
export default postBsoLocalVariationsPublicationsRoute;
