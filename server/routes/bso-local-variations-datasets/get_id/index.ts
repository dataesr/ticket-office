...
const getBsoLocalVariationsDatasetsByIdRoute = new Elysia();

getBsoLocalVariationsDatasetsByIdRoute.get(
...
export default getBsoLocalVariationsDatasetsByIdRoute;
