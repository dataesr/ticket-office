...
updateUserDataPutRoutes.patch(
  ...
  async ({ params: { id }, body, error }) => {
    ...
    const updatedContact = await db.collection("update-user-data").findOne<updateUserDataType>({ id })
    if (!updatedContact) {
  ...
  },
  {
    ...
    detail: {
      summary: "Modifier une contribution via formulaire de mise à jour de donnée par ID",
