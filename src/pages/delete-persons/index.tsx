...
import { removeUserUrl } from "../../config/api";
...
const RemoveUserPage: React.FC<RemoveUserPageProps> = () => {
  ...
  const contributions: RemoveUserProps[] = data;
  ...
  return (
    <Container className="fr-my-5w">
      <Title as="h1">Demande de suppression de profil</Title>
